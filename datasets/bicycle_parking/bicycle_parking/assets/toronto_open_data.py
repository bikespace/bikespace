  ...
  schema = pa.DataFrameSchema(
    {
      ...
      "CITY": pa.Column(str, required=False,
  ...
  schema = pa.DataFrameSchema(
    {
      ...
      "SHELTERED": pa.Column(str, nullable=True,
        checks=pa.Check.isin(["No", "Yes"]),
      ),
      "STATUS": pa.Column(str,
        checks=pa.Check.isin(
      ...
      "MULTIMODAL": pa.Column(str, required=False,
        checks=pa.Check.isin(["No", "Yes"]),
      ),
  ...
  schema = pa.DataFrameSchema(
    {
      ...
      "ADDRESS_FULL": pa.Column(str, 
        checks=pa.Check.isin(list(BIKE_STATION_INFO.keys()))
      ),
