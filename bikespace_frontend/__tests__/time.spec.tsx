...
import { ParkingDuration, ParkingTime } from "../src/interfaces/Submission";
...
describe('Test Time page component', () => {
    ...
    render(<Time parkingDuration={parkingDuration} onParkingDurationChanged={setParkingDuration} dateTime={dateTime} />);
