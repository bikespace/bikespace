...
import {IssueType, LocationLatLng, ParkingDuration, ParkingTime, SubmissionStatus } from "../src/interfaces/Submission";

describe("Test the Summary component page", () => {
    const [issues, setIssues] = useState<IssueType[]>([IssueType.Abandoned, IssueType.Damaged]);
    ...
    render(<Summary submission={submission} submissionStatus={submissionStatus} />)
