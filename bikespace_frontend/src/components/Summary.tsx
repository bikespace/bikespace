...
const Summary = (props: { submision: Submission, submissionStatus: SubmissionStatus }) => {
  ...
  if (submissionStatus.status == "summary") {
    ...
    return (
      <div id="submission-summary">
        <h1>Oops</h1>
        <p>Something went wrong on our end processing your submission, please try again later!</p>
      </div>
    )
  } else {
    return (
      <div id="submission-summary">
        <h1>Oops!</h1>
        <p>Something went wrong beyond our expectations. Please try again later, and report this bug to the developers :(</p>
      </div>
    )
  }
};
