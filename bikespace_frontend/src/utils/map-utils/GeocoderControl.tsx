...
const geocoderApi: MaplibreGeocoderApi = {
  forwardGeocode: async config => {
    ...
    try {
      const request = `https://nominatim.openstreetmap.org/search?q=${config.query}&format=geojson&polygon_geojson=1&addressdetails=1&countrycodes=CA&viewbox=${torontoBBox.getURLParams()}&bounded=1`;
