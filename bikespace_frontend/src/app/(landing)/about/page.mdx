import {DividerImg} from '@/components/landing/content-blocks';

import testDividerImage from '@/assets/images/meadoway.png';
import testDividerImage3 from '@/assets/images/rings.png';
...
<DividerImg imageSrc={testDividerImage3.src} imageAlt='Rings' />

Research has found that a lack of bicycle parking is a particularly significant barrier for women who want to cycle [^1].
